...
//--------------
void Helpers::emplace_faces(std::vector<PosNorTexVertex>& lists, PosNorTexVertex& _v1, PosNorTexVertex& _v2,PosNorTexVertex& _v3, PosNorTexVertex& _v4) {
	_v1.TexCoord.s = 0.f;
	_v1.TexCoord.t = 0.f;
	_v2.TexCoord.s = 1.f;
	_v2.TexCoord.t = 0.f;
	...
	lists.emplace_back(_v1);
	lists.emplace_back(_v2);
	lists.emplace_back(_v4);

	lists.emplace_back(_v1);
	lists.emplace_back(_v4);
	lists.emplace_back(_v3);
}
